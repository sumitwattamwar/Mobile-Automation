...
public class Contact_Us {
	...
	public static void openDNS_prod() throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@text='EMAIL']")).click();//Clicked on EMAIL
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@resource-id='android:id/contentPanel']")).click(); 
		Thread.sleep(3000);
	    /*driver.findElement(By.xpath("//*[@text='CALL']")).click(); //Clicked on CALL (It redirects to call log so dont use)
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@resource-id='android:id/contentPanel']")).click();
		Thread.sleep(3000);*/
		driver.findElement(By.xpath("//*[@text='CHAT']")).click();//Clicked On CHAT
		
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@text='Send us an instant message']")).sendKeys("This is an instance message form prasad");// Send Us instant msg
		Thread.sleep(3000);
