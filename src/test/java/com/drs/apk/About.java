...
Thread.sleep(2000);
		...
		driver.findElement(By.xpath(("//*[@text='About']"))).click(); //Clicked on About
		Thread.sleep(2000);
		driver.findElement(By.xpath(("//*[@text='Privacy Policy']"))).click();//Clicked on Privacy Policy
		Thread.sleep(5000);
		driver.findElement(By.xpath(("//*[@class='android.widget.ImageButton']"))).click();// Back button on privacy policy
		Thread.sleep(2000); 
		driver.findElement(By.xpath(("//*[@text='Terms Of Service']"))).click();
		Thread.sleep(2000); 
		driver.findElement(By.xpath(("//*[@class='android.widget.ImageButton']"))).click();// Back button on Terms of service
		Thread.sleep(2000); 
		driver.findElement(By.className("android.widget.ImageButton")).click(); //Back button on PP and TS page
