...
public class Add_Connection_Button_NetworkTab {
	...
	public static void openDNS_prod() throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElementByXPath("//*[@resource-id='com.healthpole.dentists.debug:id/floating_action_button']").click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("//*[@text='Search from all members']")).sendKeys("sumit");//Search from all members
		Thread.sleep(5000);
		driver.findElements(By.xpath("//*[@class='android.widget.TextView']")).get(4).click();
		Thread.sleep(2000);
		driver.findElements(By.xpath("//*[@class='android.widget.TextView']")).get(4).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("//*[@text='DONE']")).click();//Clicked on DONE
		Thread.sleep(3000);
