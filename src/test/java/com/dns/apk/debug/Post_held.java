...
public class Post_held extends BaseClass 

{
	...
	@Test
    static void Post_Held() throws InterruptedException
    {
        ...
        driver.findElement(By.xpath("//*[@text='+Add' and (./preceding-sibling::* | ./following-sibling::*)[@text='Posts Held']]")).click();//Add 
		
        driver.findElement(By.xpath("//*[@id='edit_text_title']")).sendKeys("General Physician"); //Post name
        
        driver.findElement(By.xpath("//*[@id='edit_text_subtitle_1']")).sendKeys("JSPM"); //org name
		...
		//driver.findElement(By.xpath("//*[@contentDescription='Navigate up']")).click();//back
		 Reporter.log("Post Held Added succceessfully",true);
    }
}
