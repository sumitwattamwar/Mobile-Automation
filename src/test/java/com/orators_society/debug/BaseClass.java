...
public  class BaseClass {
	...
	public static void Setup () throws MalformedURLException, InterruptedException
	{
		...
		Thread.sleep(1000);
		dc.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.cultivity.orators_society.debug");
		dc.setCapability( AndroidMobileCapabilityType.APP_ACTIVITY,"com.bootinfotech.toastmasters.social.views.activities.SplashActivity");
